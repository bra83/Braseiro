...
async function box(page:any,anchor:string){return await page.locator(`[data-anchor="${anchor}"]`).evaluate((e:HTMLElement)=>{let x=0,y=0,n:HTMLElement|null=e;while(n){x+=n.offsetLeft||0;y+=n.offsetTop||0;n=n.offsetParent as HTMLElement|null}return{x,y,w:e.offsetWidth,h:e.offsetHeight}})}
